                                                ...
                                                <ItemTemplate>
                                                    <div class="hidden-sm hidden-xs btn-group">
                                                        <asp:LinkButton ID="btnEditRow" runat="server" PostBackUrl="~/Setup/UserSetup.aspx" OnClientClick="ShowWizForm();" 
                                                            CommandName="EditRow" CommandArgument='<%# Container.DataItemIndex %>' CssClass="btn btn-white btn-minier btn-bold">
...
<<<<<<< HEAD
    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            $('#<%=gvUsers.ClientID%> > thead > tr > th input[type=checkbox], #<%=gvUsers.ClientID%>_wrapper input[type=checkbox]').eq(0).on('click', function () {
                var th_checked = this.checked;//checkbox inside "TH" table header

                $('#<%=gvUsers.ClientID%>').find('tbody > tr').each(function () {
                    var row = this;
            ...
            $('#<%=gvUsers.ClientID%>').on('click', 'td input[type=checkbox]', function () {
