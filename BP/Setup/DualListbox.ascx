<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DualListbox.ascx.cs" Inherits="BP.Setup.DualListbox" %>

<div class="dummy">
    <asp:ListBox ID="dlbGeneric" SelectionMode="Multiple" ClientIDMode="Static" runat="server"></asp:ListBox>
