<%@ Page Title="Period Perjawatan" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PeriodPerjawatanSetup.aspx.cs" Inherits="BP.PeriodPerjawatanSetup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BreadcrumbsContent" runat="server">
    <ul class="breadcrumb">
        ...
        <li class="active">Period Perjawatan</li>
    </ul><!-- /.breadcrumb -->
</asp:Content>
    ...
    <div class="page-header">
		<h1>
			...
			<small>
				...
				setup &amp; manage field/period perjawatan
			</small>
		</h1>
	</div><!-- /.page-header -->
</asp:Content>
        ...
        <div class="col-xs-12 widget-container-col" id="widget-container-col-2">
			<div class="widget-box" id="widget-box-edit">
				<div class="widget-header">
					<h5 id="widget_title" class="widget-title" runat="server">Period Perjawatan - New</h5>
				...
				<div class="widget-body">
					<div class="widget-main">
                        ...
                        <div id="edit-form" class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="tbFieldPerjawatan">Field Perjawatan:</label>

                                <div class="col-xs-12 col-sm-9">
                                    <div class="clearfix">
                                        <asp:TextBox ID="tbFieldPerjawatan" runat="server" ReadOnly="true" CssClass="col-xs-12 col-sm-6"></asp:TextBox>
                                    </div>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbFieldPerjawatan" Display="Dynamic" 
                                        CssClass="help-block" ErrorMessage="Field Perjawatan is required." ValidationGroup="SaveValidation"  />
                                    <asp:CustomValidator ID="CustomValidator1" runat="server" ClientValidationFunction="CustomValidationFunction" Display="None"
                                        ValidateEmptyText="True" ValidationGroup="SaveValidation" ControlToValidate="tbFieldPerjawatan" SetFocusOnError="true" />
                                </div>
                            </div>
    ...
    <div id="ListForm" runat="server">
        <div class="col-xs-12 widget-container-col" id="widget-container-col-1">
			<div class="widget-box" id="widget-box-list">
				<div class="widget-header">
					<h5 class="widget-title">Period Perjawatan - List</h5>
						    ...
						    <ul class="dropdown-menu dropdown-menu-right dropdown-light-blue dropdown-caret dropdown-closer">
							    <li> 
                                    <asp:LinkButton ID="btnAdd" runat="server" CssClass="blue" OnClientClick="ShowForm();" OnClick="btnAdd_Click">
                                        <i class="ace-icon glyphicon glyphicon-file"></i>&nbsp;&nbsp;Add Period Perjawatan
                                    </asp:LinkButton>
							    </li>
						    </ul>
					    </div>
				...
				<div class="widget-body">
					<div class="widget-main">
                        ...
                        <div class="form-horizontal" role="form">
                            ...
                            <asp:GridView ID="gvPeriodPerjawatanSetup" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered table-striped table-hover"
                                DataKeyNames="PeriodPerjawatanID,FieldPerjawatanID" OnRowCommand="gvPeriodPerjawatanSetup_RowCommand"
                                OnRowDataBound="gvPeriodPerjawatanSetup_RowDataBound" OnPreRender="gvPeriodPerjawatanSetup_PreRender">
                                 <Columns>
    ...
    <script type="text/javascript">
        ...
        function InitScript() {
            ...
            $('#widget-box-edit').on('closed.ace.widget', function (event, info) {
                ...
                $("#MainContent_gvPeriodPerjawatanSetup tr").each(function () {
        ...
        function LoadDataTable() {
            ...
            var myTable = $('#<%=gvPeriodPerjawatanSetup.ClientID%>').DataTable({
                bAutoWidth: false,
                "aoColumns": [
					  null,
                      null,
            ...
            $(document).on('click', '#<%=gvPeriodPerjawatanSetup.ClientID%> .dropdown-toggle', function (e) {
