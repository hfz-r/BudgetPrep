	    ...
	    <div class="modal-dialog" style="width:400px;">
		    <div class="modal-content">
                <div class="modal-header">
					...
					<h5 class="blue bigger">Account Code Custom File Upload Box</h5>
				</div>
                        ...
                        <div class="form-horizontal" id="edit-form" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-9">
                                    ...
                                    <asp:RequiredFieldValidator ID="AccountCodeRequired" runat="server" ControlToValidate="tbCode" ForeColor="Red"
                                        CssClass="help-block" ErrorMessage="Account Code is required." ToolTip="Account Code is required." Display="Dynamic"
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="duallist">Description:</label>
                                ...
                                <div class="col-xs-12 col-sm-9">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="tbDesc" ForeColor="Red"
                                        CssClass="help-block" ErrorMessage="Description is required." ToolTip="Description is required." Display="Dynamic"
                                        ValidationGroup="SaveValidation" />
                                </div>
                            </div>
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-9 col-md-9">
                                    ...
                                    <button id="btnCancel" type="reset" class="btn" runat="server">
                        ...
                        <div class="widget-menu">
						    ...
						    <ul class="dropdown-menu dropdown-menu-right dropdown-light-blue dropdown-caret dropdown-closer">
							    <li>
                                    ...
                                    <a href="#modal-form" id="btnFileUpload" role="button" class="blue" data-toggle="modal" data-rel="tooltip" 
